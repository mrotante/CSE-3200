...
import com.example.midterm.databinding.FragmentNotificationsBinding
...
class NotificationsFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val timerText : TextView = binding.timer3

        val startButton : Button = binding.t3start
        val stopButton : Button = binding.t3stop
        val resetButton : Button = binding.t3reset
